...
def get_graph_name_scale_map(graph_scale_log_path):
    """
    :param graph_scale_log_path: Each line in graph_title scale log is formatted as
    "graph_title name \t node number \t edge number"
...
def get_graph_instances(graph_dir, graph_name_str, instances, pattern, sep):
    ...
    :param graph_name_str: the str to identify the position of graph_title name in pattern
    ...
    :return: [..., graph_id_i, ...]
    graph_id_i is instance_i's graph_title id.
    """

    # put the graph_title name involved in instances together in a list
...
def get_edge_list(graph_path):
    """
    :param graph_path:
    :return: edge list of graph_title
    e.g. [..., (vi, vj), .... ]
