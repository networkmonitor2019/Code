...
from MaximizeDegreeDiscountHeuristic import do_maximize_degree_discount_heuristic_job
...
if __name__ == '__main__':
    ...
    """
       ...
       2. Use |V| and trunc_point_num to get trunc_step.
    ...
    messages = run_multi_process(do_maximize_degree_discount_heuristic_job,
                                 needed_cpu_num,
                                 job_assign_res,
    ...
    #do_maximize_degree_discount_heuristic_job(job_list)
